...
const ClientSessions = () => {
  ...
  async function fetchSessions() {
    const sessions = await sessionsService.getClientSessions();
      ...
      <CssBaseline />
        <Stack direction={"column"} spacing={2}>
          ...
          <p style={{ width: "100%", textAlign: "center", fontSize: "20px" }}>
            All your registered sessions can be found here!
          </p>
        </Stack>
        <br />
        <div>
              ...
              <Table sx={{ minWidth: 700 }} aria-label="customized table">
                <TableHead>
                  <TableRow>
                    ...
                    <StyledTableCell align="right">Therepuet</StyledTableCell>
                ...
                <TableBody>
                  {sessions.map((session) => (
                    <StyledTableRow key={session.id}>
                      ...
                      <StyledTableCell align="right">
                        {session.therepuet.user.name}{" "}
                        {session.therepuet.user.surname}
                      </StyledTableCell>
                      <StyledTableCell align="right">
                        <Button
