	  ...
	  <CssBaseline />
        <Stack direction={"column"} spacing={2}>
          ...
          <p style={{ width: "100%", textAlign: "center", fontSize: "20px" }}>
            Welcome to Connect! Here you can find all available seanses with
            therapuets you need. Check out all qualifications pur therapuets
            qualify in below!
          </p>
        </Stack>
        <Grid
          sx={{ py: 4, flex: "display", justifyContent: "center" }}
          container
          spacing={6}
        >
            ...
            qualifications.map((qualification) => (
              <Grid item key={qualification.id} xs={12} sm={6} md={6} lg={4}>
                ...
                >
                  ...
                  <CardActions>
                    <Button
                      onClick={() => navigateToTherepuets(qualification.id)}
                      size="small"
                    >
                      See therepuets
                    </Button>
